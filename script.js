...
for (let i = 0; i < 10; i++) {
    ...
    let answer = (num1+num2) == equasion ? ' Молодец, это правильный ответ'  :  'К сожалению ваш ответ "'+ equasion + '" неправильный.';  
    console.log(num1+' + '+ num2 + '=' +' ' +(num1 + num2) + ' Ваш ответ ' + equasion + '    ' + answer) ;
